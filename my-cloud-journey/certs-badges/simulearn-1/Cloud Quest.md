...
<img width="720" height="556" alt="Cloud Practioner Certificate" src="https://github.com/user-attachments/assets/a8e35fda-9842-4663-bf81-00c2d10cfbec" />

## Topics Covered

- AWS Cloud fundamentals (scalability, elasticity, high availability, cost optimisation)
- Core AWS services: EC2, S3, RDS, VPC, DynamoDB
- AWS Global Infrastructure: Regions, Availability Zones, and Edge Locations
- Cloud security, pricing models, and support frameworks

## Key Takeaways

- Gained hands-on experience deploying real cloud solutions in a live AWS environment.
- Built practical skills in core AWS services including EC2, S3, RDS, and VPC.
- Developed the ability to design resilient, cost-effective cloud architectures.
- Completed an industry-aligned curriculum recognised as "Day 1 Job Ready" by AWS.
